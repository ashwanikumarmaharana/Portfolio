...
const About = () => {
  return (
    <div className='w-full max-w-[1200px] mx-auto bg-black pt-1 md:pt-20' id="about">
      <h1 className='text-white text-4xl sm:text-5xl lg:text-6xl max-w-[320px] mx-auto font-semibold p-4 mb-4'>
        About <span className='text-orange-400'>Me</span>
      </h1>

      <div className='px-4 sm:px-6 md:px-8 lg:p-0 grid grid-cols-1 md:grid-cols-8 gap-6 place-items-center'>
        {/** Section 1 */}
        <div className='w-full h-[200px] md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden transition-transform transform hover:scale-102'>
          <div className='absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy'></div>
          <div className='flex flex-row p-4 sm:p-6'>
            ...
            <div className='flex flex-col mt-4'>
              ...
              <p className='text-md sm:text-lg text-white/70 mt-2 line-clamp-3'>
        ...
        {/** Section 2 */}
        <div className='w-full h-[200px] md:col-span-3 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden transition-transform transform hover:scale-102'>
          <div className='absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy'></div>
          <div className='flex flex-row p-4 sm:p-6'>
        ...
        {/** Section 4 */}
        <div className='w-ful h-[200px] md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden transition-transform transform hover:scale-102'>
          <div className='absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy'></div>
          <div className='flex flex-row p-4 sm:p-6'>
